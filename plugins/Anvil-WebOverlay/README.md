...
![The demo plugin: an HTML panel, a transparent HUD and a WebGL cube over the game](https://raw.githubusercontent.com/maschine34675/WebOverlay/v1.11.0/assets/demo.gif)
...
- Events arrive on the overlay's own thread by default. Queue what a handler
  ...
  [`docs/API.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/API.md).
- The example above makes the library a **hard** dependency, which is the
  ...
  both are in
  [`docs/SOFT-DEPENDENCY.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/SOFT-DEPENDENCY.md).
- Instead of `LoadHtml`, a page can be real files served from your plugin
  folder - with storage, fonts and no size limit; see
  [`docs/RECIPES.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/RECIPES.md).
...
source, [`WebOverlay.Demo/DemoPlugin.cs`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/WebOverlay.Demo/DemoPlugin.cs),
...
[`PanelPlugin.cs`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/examples/PanelPlugin.cs)
(a hotkey window with raid-suitable options),
[`HudPlugin.cs`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/examples/HudPlugin.cs)
(a transparent click-through HUD, with the hideout decision as a comment), and
[`WebOverlayGate.cs`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/examples/WebOverlayGate.cs)
...
| | |
|---|---|
| [`docs/API.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/API.md) | every member, the options, events, failure causes, channels and request/reply, threading, ordering |
| [`docs/RECIPES.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/RECIPES.md) | HUDs and transparency, shaping, real files and web fonts, previewing without the game, performance, security defaults |
| [`docs/TROUBLESHOOTING.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/TROUBLESHOOTING.md) | by symptom: dead mouse, flickering cursor, wrong fonts, missing window - and what a useful bug report contains |
| [`docs/SOFT-DEPENDENCY.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/SOFT-DEPENDENCY.md) | using the library as an optional dependency without breaking anyone, plus the version table |
| [`docs/STYLE.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/STYLE.md) | the shared design tokens `InjectTheme` provides |
| [`docs/INTERNALS.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/INTERNALS.md) | how it works and why it looks like this; the review history |
| [`docs/FAULT-TESTS.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/FAULT-TESTS.md) | the measured evidence - one row per proven behaviour |
| [`CHANGELOG.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/CHANGELOG.md) | what changed between versions; this file describes the library as it is now |
...
[`docs/TROUBLESHOOTING.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/TROUBLESHOOTING.md);
what a HUD has to decide for itself - menus, the hideout, showing and hiding -
is in
[`docs/RECIPES.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/RECIPES.md#translucency-and-huds).
...
is at the end of
[`docs/TROUBLESHOOTING.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/TROUBLESHOOTING.md#reporting-a-problem).
Reports go to
...
[`scripts/New-ReleasePackage.ps1`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/scripts/New-ReleasePackage.ps1)
...
[`tools/Probe`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/tools/Probe)
is the test host behind
[`docs/FAULT-TESTS.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/docs/FAULT-TESTS.md);
it ships in no release, and its `preview` mode shows your own page in a real
overlay without starting the game.

## If you are an AI coding agent

Read [`AGENTS.md`](https://github.com/maschine34675/WebOverlay/blob/v1.11.0/AGENTS.md),
